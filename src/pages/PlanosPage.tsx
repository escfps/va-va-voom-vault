...
import { Check, X, Star, Zap, Copy, PartyPopper } from "lucide-react";
          ...
          <div className="max-w-sm mx-auto px-4 space-y-6">
            ...
            <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-4 space-y-2">
              ...
              <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                ...
                <li>Clique no botão abaixo e envie pelo WhatsApp</li>
            ...
            {/* Botão WhatsApp */}
            <a
              href={`https://wa.me/5554974005942?text=${encodeURIComponent(`Olá! Segue o comprovante do pagamento do Plano ${plan.name} (${plan.label}). 📎`)}`}
              target="_blank"
